              ...
              <div class="single-blog single-column">
                ...
                <div class="post-content overflow">
                  ...
                  <h3 class="post-author">
                    <a>Posted by {{ $object->author ? $object->author->username : 'administrator' }}</a>
                    <small class="post-date">{{ $object->created_at }}</small>
                  </h3>
                  ...
                  <div class="author-profile padding">
                    <div class="row">
                      ...
                      <div class="col-sm-10">
                        ...
                        <a
                          href="mailto:{{ $object->author ? $object->author->email : '' }}">{{ $object->author ? $object->author->email : '' }}</a>
                      </div>
                    </div>
                  </div>
