...
@section('content')
  @include('webed-theme::front._partials.breadcrumbs', ['title' => $object->title, 'description' => $object->description])
                ...
                <div class="single-blog single-column">
                  ...
                  <div class="post-content overflow">
                    ...
                    <h3 class="post-author">
                      <a>Posted by {{ $post->author ? $post->author->username : 'administrator' }}</a>
