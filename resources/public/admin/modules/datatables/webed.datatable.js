var LaravelElixirBundle = function (t) {
    "use strict";
    var e = function (t, e) {
        if (void 0 === e && (e = {}), t) {
                ...
                dataTableParams: {
                    ...
                    ajax: {
                        url: "", type: "POST", timeout: 2e4, data: function (t) {
                            ...
                            return e.customActionMessage && WebEd.showNotification(e.customActionMessage, e.customActionStatus), $("input[name=group_checkable]").trigger("change"), 1 === $(".group-checkable", t).size() && $(".group-checkable", t).attr("checked", !1), o.onSuccess.call(void 0, a, e), WebEd.unblockUI(a.$tableContainer), e.data
                        }, error: function () {
                            this.onError.call(void 0, a), WebEd.showNotification(this.dataTableParams.language.ajaxRequestGeneralError, "danger"), WebEd.unblockUI($tableContainer)
                        }
                    },
            ...
            this.options = $.extend(!0, o, e), $.fn.dataTableExt.oStdClasses.sWrapper = $.fn.dataTableExt.oStdClasses.sWrapper + " dataTables_extended_wrapper", $.fn.dataTableExt.oStdClasses.sFilterInput = "form-control input-xs input-sm input-inline", $.fn.dataTableExt.oStdClasses.sLengthSelect = "form-control input-xs input-sm input-inline", this.datatable = this.$table.DataTable(this.options.dataTableParams), a.resetFilter(), this.$tableContainer = this.$table.closest(".table-container"), this.$tableWrapper = this.$table.closest(".dataTables_wrapper"), this.$tableContainer.addClass("initialized"), 1 === $(".table-actions-wrapper", a.$tableContainer).size() && ($(".table-group-actions", a.$tableWrapper).html($(".table-actions-wrapper", a.$tableContainer).html()), $(".table-actions-wrapper", a.$tableContainer).remove()), this.$table.on("click", ".filter-submit", function (t) {
                ...
                var t = a.$table.find('tbody > tr > td:nth-child(1) input[type="checkbox"]'), e = $(this).prop("checked");
                $(t).each(function () {
                    $(this).prop("checked", e)
                }), a.countSelectedRows()
    ...
    return e.prototype.countSelectedRows = function () {
        var t = $('tbody > tr > td:nth-child(1) input[type="checkbox"]:checked', this.$table).size(), e = this.options.dataTableParams.language.groupActionCount;
        ...
        $("textarea.form-filter, input.form-filter", this.$table).each(function () {
            ...
            var t = $(this), e = t.find("option:first-child").attr("value");
            t.val(e)
        }), $('input.form-filter[type="checkbox"]', this.$table).each(function () {
            $(this).attr("checked", !1)
        }), this.submitFilter()
    }, WebEd.DataTable = e, t.DataTable = e, t
}({});
